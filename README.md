...
Converting ASCII to web code usually means translating plain text or special characters into HTML entities, URL-encoded strings, or [JavaScript strings](https://wiki.q-researchsoftware.com/wiki/JavaScript_Color_Table) so that they display correctly in the browser.
...
[ANSI terminal color codes](https://en.wikipedia.org/wiki/ANSI_escape_code) (ASCII art) to [HTML web colors](https://simple.wikipedia.org/wiki/Web_color). In classic terminal scripts and ASCII art, text colors are controlled via so-called ANSI escape sequences. Modern websites use CSS styles to display these colors in the browser.
...
JavaScript WebColor : https://wiki.q-researchsoftware.com/wiki/JavaScript_Color_Table

...
uses
  ...
  Dialogs, Menus, ExtCtrls, Buttons, StdCtrls, ComCtrls;
...
begin
  ...
  aborted := False;
  if bmp = nil then
    MessageBox(Handle, 'No Image loaded!',
      'Error', MB_OK)
  else
    if SaveDialog.Execute then
    begin
      frmProcess.pbProgress.Position := 0;
      frmProcess.lblConvertion.Caption := 'Convert to HTML (0%)... please wait.';
      ...
      begin
        ...
        begin
          ...
          frmProcess.lblConvertion.Caption := 'Convert to HTML (' + IntToStr(frmProcess.pbProgress.Position) + '%)... please wait.';
          Sleep(50);
          Application.ProcessMessages;
        end;
